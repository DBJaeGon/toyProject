...
module.exports = (sequelize, DataTypes) => {
  class users extends Model {
    ...
    static associate(models) {
      const { users, contents, comments, images, imageComments } = models;
      users.hasMany(contents, { foreignKey: "userId", sourceKey: "id" });
      users.hasMany(comments, { foreignKey: "userId", sourceKey: "id" });
      users.hasMany(images, { foreignKey: "userId", sourceKey: "id" });
      users.hasMany(imageComments, { foreignKey: "userId", sourceKey: "id" });
    }
  }
  users.init(
    {
