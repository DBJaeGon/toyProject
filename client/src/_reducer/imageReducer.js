...
export const fetchMainImage = createAsyncThunk('image/main', async(_, { rejectWithValue, getState, requestId}) => {
    try {
...
export const fetchMainImageDel = createAsyncThunk('image/delete', async(fileName, {rejectWithValue}) => {
    try {
...
const imageSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder.addCase(fetchMainImage.pending, (state, action) => {
